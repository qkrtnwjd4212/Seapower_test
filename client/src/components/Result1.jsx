    ...
    <Wrapper>
      <Container>
        ...
        <TrashDetail>
          ...
          바다동물의 몸에 낚싯줄, 밧줄, 그물 등이 걸리거나, 버려진 어망에 걸려 죽는 유령어업 문제도 심각합니다. UNEP에 따르면, 매년 바다새가 100만 마리, 고래나 바다표범, 바다소 등 보호해야 할 해양포유동물이 10만 마리나 해양폐기물에 걸려 죽어가는 것으로 알려져 있습니다. 폐기물은 위장에 쌓여 포만감을 주기 때문에 바다생물들을 서서히 죽어가게 만들기도 합니다.
